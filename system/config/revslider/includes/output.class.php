		...
		**/
		...
		switch($type){
			...
			case 'button':
				...
				$max_width = (object)RevSliderFunctions::getVal($layer, 'max_width', 'auto');
				$max_height = (object)RevSliderFunctions::getVal($layer, 'max_height', 'auto');
				$white_space = (object)RevSliderFunctions::getVal($layer, 'whitespace', 'nowrap');
