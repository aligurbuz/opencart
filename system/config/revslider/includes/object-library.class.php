			...
			function createFontIcons() {
				...
				if (sheets)
					jQuery.each(sheets,function(index,sheet) {
						...
						var found = false,
							markup = "";	
						if (sheet && sheet.href && sheet.href.indexOf("config/revslider/public/assets/fonts/")>=0) {							
							try{
...
//				
                                        $res_img->resize($upload_directory.$file_name_with_ending, $width, $height,$upload_directory.$newfilename);
                                }
			}
