...
class RevSliderSlide extends RevSliderElementsBase{
	 ...
	 */
	public function initByData($record,$type = null){
...
//				}
		...
		$this->arrLayers = $layers;
               // var_dump('from data');var_dump($layers);
...
//		}
	...
	public function initByStaticID($slideid){
		...
		//var_dump($record);die('once');
		$this->initByData($record,'static');
	}
...
//		$this->imageThumb = RevSliderFunctionsWP::getUrlAttachmentImage($imageID,RevSliderFunctionsWP::THUMB_MEDIUM);
	...
	public function getImageUrl(){
               ...
               return UniteFunctionsWPRev::getImageUrlFromPathOc($this->imageUrl);
	}
	...
	public function getThumbUrl(){
		$thumbUrl = UniteFunctionsWPRev::getImageUrlFromPathOc($this->imageUrl);//;
		if(!empty($this->imageThumb))
			UniteFunctionsWPRev::getImageUrlFromPathOc($this->imageThumb);//$thumbUrl = $this->imageThumb;
