	...
	class UniteSettingsRev{
		...
		public function loadXMLFile($filepath){
			...
			foreach($fieldsets as $fieldset){
				...
				if(isset(ControllerExtensionModulerevslideropencart::$lang_var[$sapLabel]))
					$sapLabel = (string)ControllerExtensionModulerevslideropencart::$lang_var[$sapLabel];
				...
				foreach($fields as $field){
					...
					if($fieldLabel != '' && isset(ControllerExtensionModulerevslideropencart::$lang_var[$fieldLabel]))
						$fieldLabel = ControllerExtensionModulerevslideropencart::$lang_var[$fieldLabel];
