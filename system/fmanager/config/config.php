...
$config = array(
    ...
    //custom by shahin
    'upload_dir_view_url' => 'image/catalog/revslider_media_folder/',
    'token' =>$token[2],
    //absulate path
    'upload_dir' => DIR_IMAGE.'catalog/revslider_media_folder/',
    //root director
    'upload_dir_view' => HTTPS_CATALOG . 'image/catalog/revslider_media_folder/',
    'assets_dir' => HTTPS_CATALOG . 'system/fmanager/',
    'assets_dir_img' => HTTPS_CATALOG . 'system/fmanager/img/',
    'assets_dir_icon' => HTTPS_CATALOG . 'system/fmanager/img/ico/',
    'upload_php' => HTTPS_CATALOG . 'admin/index.php?route=extension/module/fmanager/upload&'.$token_style.'='.$token[2],
    'dialog_php' => HTTPS_CATALOG . 'admin/index.php?route=extension/module/fmanager&'.$token_style.'='.$token[2],
    'dialog_php_reload' => HTTPS_CATALOG . 'admin/index.php?route=extension/module/fmanager&'.$token_style.'='.$token[2].'&',
    'ajax_calls_php' => HTTPS_CATALOG . 'admin/index.php?route=extension/module/fmanager/ajax_calls&'.$token_style.'='.$token[2].'&action=save_img',
    'sds_ajax_calls_php' => HTTPS_CATALOG . 'admin/index.php?route=extension/module/fmanager/ajax_calls&'.$token_style.'='.$token[2].'&',
    'sds_force_download_php' => HTTPS_CATALOG . 'admin/index.php?route=extension/module/fmanager/download&'.$token_style.'='.$token[2],
    /*
      |--------------------------------------------------------------------------
    ...
    // absulate path
    'current_path' =>  DIR_IMAGE.'catalog/revslider_media_folder/',
    'current_path_host' => HTTPS_CATALOG . 'image/catalog/revslider_media_folder/',
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'thumbs_base_path' => DIR_IMAGE . 'catalog/revslider_media_folder/thumbs/',
    //'thumbs_path_orginal' => HTTP_SERVER . 'media/com_revslider/sds_rfm/thumbs/',
    //'source_path_orginal' => HTTP_SERVER . 'media/com_revslider/sds_rfm/source/',
    'thumbs_path_orginal' => HTTPS_CATALOG . 'image/catalog/revslider_media_folder/thumbs/',
    'source_path_orginal' => HTTPS_CATALOG . 'image/catalog/revslider_media_folder/',
    /*
      |--------------------------------------------------------------------------
    ...
    /* --------------------------------------------------------------------------
      ...
      |-------------------------------------------------------------------------- */
    'ftp_thumbs_dir' => DIR_UPLOAD . 'thumbs/',
    'ftp_ssl' => false,
    'ftp_port' => 21,
