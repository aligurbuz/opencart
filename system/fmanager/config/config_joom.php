...
//    custom by shahin
    'upload_dir_view_url' => 'media/com_revslider/sds_rfm/source/',
    
    
    'upload_dir' => JPATH_ROOT . '/media/com_revslider/sds_rfm/source/',
    'upload_dir_view' => JUri::root() . 'media/com_revslider/sds_rfm/source/',
    'assets_dir' => JUri::root() . 'media/com_revslider/sds_rfm/',
    'assets_dir_img' => JUri::root() . 'media/com_revslider/sds_rfm/img/',
    'assets_dir_icon' => JUri::root() . 'media/com_revslider/sds_rfm/img/ico/',
    'upload_php' => JUri::root() . 'administrator/index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.upload',
    'dialog_php' => JUri::root() . 'administrator/components/com_revslider/include/filemanager/dialog.php',
    'dialog_php_reload' => JUri::root() . 'administrator/?option=com_revslider&view=sdsfm&task=sdsfm.filemanager&',
    'ajax_calls_php' => JUri::root() . 'administrator/index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=save_img',
    'sds_ajax_calls_php' => JUri::root() . 'index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&',
    'sds_force_download_php' => JUri::root() . 'administrator/index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fdownload',
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'current_path' => JPATH_ROOT . '/media/com_revslider/sds_rfm/source/',
    'current_path_host' => JUri::root() . 'media/com_revslider/sds_rfm/source/',
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'thumbs_base_path' => JPATH_ROOT . '/media/com_revslider/sds_rfm/thumbs/',
    'thumbs_path_orginal' => JUri::root() . 'media/com_revslider/sds_rfm/thumbs/',
    'source_path_orginal' => JUri::root() . 'media/com_revslider/sds_rfm/source/',
    /*
      |--------------------------------------------------------------------------
    ...
    /* --------------------------------------------------------------------------
      ...
      |-------------------------------------------------------------------------- */
    'ftp_thumbs_dir' => JPATH_ROOT . '/media/com_revslider/sds_rfm/thumbs/',
    'ftp_ssl' => false,
    'ftp_port' => 21,
