...
?>
            ...
            var token_style = "<?php echo $token_style;?>";
        </script>
    ...
    <body>
        ...
        <input type="hidden" id="sdstoken" value="<?php echo $token; ?>" />|
        ...
        <?php if ($upload_files) { ?>
            ...
            <div class="uploader">
                <div class="text-center">
                    <button id="sds_return" class="btn btn-inverse close-uploader"><i class="icon-backward icon-white"></i> <?php echo trans('Return_Files_List') ?></button>
                </div>
...
// Should lazy loading be enabled
            ...
            <div class="row-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <?php } ?>
                    <li class="pull-right"><a id="refresh" class="btn-small" href="<?php echo $dialog_php_reload; ?><?php echo $get_params . $subdir . "&" . uniqid() ?>"><i class="icon-refresh"></i></a></li>
                                                ...
                                                <div class="img-precontainer">
                                                    ...
                                                    <div class="img-container">
                                                        ...
                                                        if ($is_img ) {
                                                            ...
                                                            ?>
                                                            <img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?><?php echo $lazy_loading_enabled ? " lazy-loaded" : "" ?>" <?php echo $lazy_loading_enabled ? "data-original" : "" ?> src="<?php echo $sds_img; ?>">
                                                        <?php } else { ?>
                                                            <img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?><?php echo $lazy_loading_enabled ? " lazy-loaded" : "" ?>" <?php echo $lazy_loading_enabled ? "data-original" : "" ?> src="<?php echo $sds_file; ?>">
                                                        <?php }
                                                        ?>
                                                    </div>
                                                </div>
