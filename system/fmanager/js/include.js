...
!function (e, a, r) {
    ...
    function n() {
        jQuery("#textfile_create_area").parent().parent().remove(), e.ajax({
            type: "GET",
            url: "index.php?route=extension/module/fmanager/ajax_calls&action=new_file_form&"+token_style+"=" + jQuery('#sdstoken').val()
        }).done(function (a) {
            bootbox.dialog(a, [{
                    ...
                    callback: function () {
                        ...
                        if (null !== a) {
                            ...
                            e.ajax({
                                type: "POST",
                                url: "index.php?route=extension/module/fmanager/execute&action=create_file&"+token_style+"=" + jQuery('#sdstoken').val(),
                                data: {
                                    token:oc_token,
                                    path: t,
                                    name: a,
    ...
    function i(a) {
        ...
        e.ajax({
            type: "POST",
            url: "index.php?route=extension/module/fmanager/ajax_calls&action=get_file&sub_action=edit&preview_mode=text&"+token_style+"=" + jQuery('#sdstoken').val(),
            data: {
                token:oc_token,
                path: r
            }
            ...
            bootbox.dialog(t, [{
                    ...
                    callback: function () {
                        ...
                        e.ajax({
                            type: "POST",
                            url: "index.php?route=extension/module/fmanager/execute&action=save_text_file&"+token_style+"=" + jQuery('#sdstoken').val(),
                            data: {
                                token:oc_token,
                                path: r,
                                new_content: a
    ...
    function l() {
        e.ajax({
            type: "POST",
            url: "index.php?route=extension/module/fmanager/ajax_calls&action=get_lang&"+token_style+"=" + jQuery('#sdstoken').val(),
            data: {
                token:oc_token
            }
        }).done(function (a) {
            bootbox.dialog(a, [{
                    ...
                    callback: function () {
                        ...
                        e.ajax({
                            type: "POST",
                            url: "index.php?route=extension/module/fmanager/ajax_calls&action=change_lang&"+token_style+"=" + jQuery('#sdstoken').val(),
                            data: {
                                token:oc_token,
                                choosen_lang: a
                            }
    ...
    function o(a) {
        ...
        e.ajax({
            type: "POST",
            url: "index.php?route=extension/module/fmanager/ajax_calls&action=chmod&"+token_style+"=" + jQuery('#sdstoken').val(),
            data: {
                token:oc_token,
                path: t,
                permissions: n,
                    ...
                    callback: function () {
                        ...
                        if ("" != n && "undefined" != typeof n) {
                            ...
                            "" != l && "undefined" != typeof l || (l = "none"), e.ajax({
                                type: "POST",
                                url: "index.php?route=extension/module/fmanager/execute&action=chmod&"+token_style+"=" + jQuery('#sdstoken').val(),
                                data: {
                                    token:oc_token,
                                    path: t,
                                    new_mode: n,
    ...
    function s() {
        bootbox.confirm(jQuery("#lang_clear_clipboard_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (a) {
            1 == a && e.ajax({
                type: "POST",
                url: "index.php?route=extension/module/fmanager/ajax_calls&action=clear_clipboard&"+token_style+"=" + jQuery('#sdstoken').val(),
                data: {
                    token:oc_token,
                }
            }).done(function (e) {
    ...
    function d(a, r) {
        if ("copy" == r || "cut" == r) {
            ...
            t = a.hasClass("directory") ? a.find(".rename-file-paths").attr("data-path") : a.find(".rename-file-paths").attr("data-path"), e.ajax({
                type: "POST",
                url: "index.php?route=extension/module/fmanager/ajax_calls&action=copy_cut&"+token_style+"=" + jQuery('#sdstoken').val(),
                data: {
                    token:oc_token,
                    path: t,
                    sub_action: r
        ...
        bootbox.confirm(jQuery("#lang_paste_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (r) {
            if (1 == r) {
                ...
                t = "undefined" != typeof a ? a.find(".rename-folder").attr("data-path") : jQuery("#sub_folder").val() + jQuery("#fldr_value").val(), e.ajax({
                    type: "POST",
                    url: "index.php?route=extension/module/fmanager/execute&action=paste_clipboard&"+token_style+"=" + jQuery('#sdstoken').val(),
                    data: {
                        token:oc_token,
                        path: t
                    }
    ...
    function h(e) {
        for (var e, a = [/[\300-\306]/g, /[\340-\346]/g, /[\310-\313]/g, /[\350-\353]/g, /[\314-\317]/g, /[\354-\357]/g, /[\322-\330]/g, /[\362-\370]/g, /[\331-\334]/g, /[\371-\374]/g, /[\321]/g, /[\361]/g, /[\307]/g, /[\347]/g], r = ["A", "a", "E", "e", "I", "i", "O", "o", "U", "u", "N", "n", "C", "c"], t = 0; t < a.length; t++)
            e = e.replace(a[t], r[t]);
        return e
    }
    ...
    function g(a, r, t, n, i) {
        null !== t && (t = _(t), e.ajax({
            type: "POST",
            url: "index.php?route=extension/module/fmanager/execute&"+token_style+"=" + jQuery('#sdstoken').val() + "&action=" + a,
            data: {
                token:oc_token,
                path: r,
                name: t.replace("/", "")
        ...
        t.each(function () {
            ...
            if (e.isNumeric(t))
                for (t = parseFloat(t);
                    ...
                    t = parseFloat(parseFloat(t) + parseFloat(.001));
            else
                t = t + "a" + a.find("h4 a").attr("data-file");
            i[t] = a.html(), l.push(t)
        }), n.each(function () {
            var a = jQuery(this),
                    t = a.find(r).val();
    ...
    var k = "9.11.3",
            ...
            S = function (e) {
                if (1 == jQuery("#ftp").val())
                    ...
                    var a = jQuery("#base_url").val() + jQuery("#cur_dir_show_url").val();
            ...
            U = {
                contextActions: {
                    ...
                    unzip: function (a) {
                        ...
                        show_animation(), e.ajax({
                            type: "POST",
                            url: "index.php?route=extension/module/fmanager/ajax_calls&action=extract&"+token_style+"=" + jQuery('#sdstoken').val(),
                            data: {
                                token:oc_token,
                                path: r
                            }
                    ...
                    edit_img: function (e) {
                        ...
                        if (1 == jQuery("#ftp").val())
                            var r = jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a;
                        else
                            var r = jQuery("#base_url").val() + jQuery("#cur_dir").val() + a;
                    ...
                    jQuery("#filter-input").on("keyup", function () {
                        ...
                        jQuery(this).val(r), a && I(function () {
                            jQuery("li", "ul.grid ").each(function () {
                                ...
                                url: "index.php?route=extension/module/fmanager/ajax_calls&"+token_style+"=" + jQuery('#sdstoken').val() + "&action=filter&type=" + r
                            }).done(function (e) {
                                "" != e && bootbox.alert(e)
                            }), I(function () {
                ...
                uploadURL: function () {
                    jQuery("#uploadURL").on("click", function (a) {
                        ...
                        show_animation(), e.ajax({
                            type: "POST",
                            url: "index.php?route=extension/module/fmanager/upload&"+token_style+"=" + jQuery('#sdstoken').val(),
                            data: {
                                token:oc_token,
                                path: t,
                                path_thumb: n,
                ...
                makeSort: function (a) {
                    ...
                    jQuery(".sorter").on("click", function () {
                        ...
                        r = jQuery("#sort_by").val() !== t.attr("data-sort") || 0 == r, a ? (e.ajax({
                            url: "index.php?route=extension/module/fmanager/ajax_calls&"+token_style+"=" + jQuery('#sdstoken').val() + "&action=sort&sort_by=" + t.attr("data-sort") + "&descending=" + (r ? 1 : 0)
    ...
    jQuery(document).ready(function () {
        ...
        if (U.makeSort(o), U.makeFilters(o), U.uploadURL(), jQuery("#info").on("click", function () {
            ...
            bootbox.prompt(jQuery("#insert_folder_name").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (a) {
                if (null !== a) {
                    ...
                    e.ajax({
                        type: "POST",
                        url: "index.php?route=extension/module/fmanager/execute&action=create_folder&"+token_style+"=" + jQuery('#sdstoken').val(),
                        data: {
                            token:oc_token,
                            path: r,
                            name: a
            ...
            jQuery(".view-controller button").removeClass("btn-inverse"), jQuery(".view-controller i").removeClass("icon-white"), a.addClass("btn-inverse"), a.find("i").addClass("icon-white"), e.ajax({
                url: "index.php?route=extension/module/fmanager/ajax_calls&"+token_style+"=" + jQuery('#sdstoken').val() +
                        "&action=view&type=" + a.attr("data-value")
            }).done(function (e) {
                "" != e && bootbox.alert(e)
        ...
        for (var a = e.split("/"), r = 3; r < a.length; r++)
            a[r] = encodeURIComponent(a[r]);
        return a.join("/")
    }, apply = function (a, r) {
        var t;
        ...
        var s = "",
                ...
                f = ["mp4", "ogg", "webm"];
        if (1 == jQuery("#ftp").val())
            var p = encodeURL(jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a);
        else
            var y = jQuery("#return_relative_url").val(),
        ...
        if ("" != r)
            ...
            e.inArray(c, ext_img) > -1 ? (p = p + "?" + (new Date).getTime(), s = '<img src="' + p + '" alt="' + u + '" />') : e.inArray(c, f) > -1 ? s = '<video controls source src="' + p + '" type="video/' + c + '">' + u + "</video>" : e.inArray(c, d) > -1 ? ("mp3" == c && (c = "mpeg"), s = '<audio controls src="' + p + '" type="audio/' + c + '">' + u + "</audio>") : s = '<a href="' + p + '" title="' + u + '">' + u + "</a>", 1 == jQuery("#crossdomain").val() ? t.postMessage({
                sender: "responsivefilemanager",
                url: p,
                field_id: null,
                html: s
        ...
        if (1 == jQuery("#ftp").val())
            var o = encodeURL(jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + e);
        else
            var u = jQuery("#return_relative_url").val(),
        ...
        if ("" != a)
            ...
            jQuery("#add_time_to_img").val() && (o = o + "?" + (new Date).getTime()), apply_any(o)
