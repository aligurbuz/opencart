...
<div id="content">
  ...
  <div class="panel panel-default">
        ...
        <div class="panel-body install-panel">
              <center><i class="fa fa-spinner fa-spin"></i> Markalar İndiriliyor Bekleyiniz...</center>
          </div>
        </div>
  </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function() {
      starttool('index.php?route=trendyol/brands/downloadbrands&user_token=<?php echo $user_token; ?>');
  });
      ...
      $.ajax({
        ...
        success: function(json) {
            ...
            if(json['next']){
               ...
               window.location.href = "index.php?route=trendyol/dashboard&user_token=<?php echo $user_token; ?>"; 
            }
        }
      });
  }
